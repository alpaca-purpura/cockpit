...
| F1 | F1.0-terreno | sistema | `arquitectura-refichado-ck21` | transversal | alta | developing |
| F1 | F1.0-terreno | sistema | `schema-v2-hilo-de-oro-kinetica` | transversal | alta | idea |

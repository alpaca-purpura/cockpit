...
`GET /api/portfolio` · `GET /api/negocio?empresa=<id>` · `GET /api/objeto?empresa=<id>` (las 9 entidades juntas).
...
El objeto de negocio normalizado (9 entidades) es **`sistema/schema/objeto.schema.yaml`** (SSoT), servido por
